...
public interface Visualizer {
    ...
    void visualize(long currentIterationNumber, int numberOfObjects, long runTime, String[] ids, boolean[] deleted,
                   double[] positionX, double[] positionY, double[] radiuses, int[] colors);

    void end();

    void visualize(List<SimulationObject> objects, long runTime, long currentIterationNumber);
